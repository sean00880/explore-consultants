        ...
        <>
            <ul className="navigation clearfix">
                ...
                <li class="dropdown"><Link href="/page-about">Pages</Link>
                    ...
                    <div className={isActive.key === 2 ? "dropdown-btn active" : "dropdown-btn"} onClick={() => handleClick(2)}><i class="fa fa-angle-down"></i></div>
                </li>
                ...
                <li class="dropdown"><Link href="/page-services">Services</Link>
                    ...
                    <div className={isActive.key === 4 ? "dropdown-btn active" : "dropdown-btn"} onClick={() => handleClick(4)}><i class="fa fa-angle-down"></i></div>
                </li>

                <li class="dropdown"><Link href="/page-news">News</Link>
                    <ul className={isActive.key === 5 ? "d-block" : "d-none"}>
                        <li><Link href="/page-news">News Grid</Link></li>
                        <li><Link href="/page-news-details">News Details</Link></li>

                    </ul>
                    <div className={isActive.key === 5 ? "dropdown-btn active" : "dropdown-btn"} onClick={() => handleClick(5)}><i class="fa fa-angle-down"></i></div>
                </li>
